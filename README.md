<p align="center">
  <picture>
    ...
    <img src="docs/assets/cover-light.svg" alt="curl Request Builder — Build A Curl Command Field By Field, in the Terminal Workbench style" width="100%">
  </picture>
</p>

<p align="center">
  <a href="https://real-fruit-snacks.github.io/curl-request-builder/"><strong>Live site</strong></a> ·
...
Build a curl command from method, headers, auth, body, and options — assembled live with correct POSIX quoting and a copy button. Styled with the
...
**Offline / airgapped:** grab the zip from the [latest release](https://github.com/Real-Fruit-Snacks/curl-request-builder/releases/latest)
